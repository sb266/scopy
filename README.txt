A custom implementation of scopy. Instead of Unix file access controls, this version uses file UID bits and a
permissions file to allow or deny user access. The program can be used by authorized users to make their own
copies of files which they may not necessarily be able to interact with directly.
